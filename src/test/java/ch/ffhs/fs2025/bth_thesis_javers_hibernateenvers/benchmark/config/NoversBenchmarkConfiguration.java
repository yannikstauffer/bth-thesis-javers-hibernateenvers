...
@EntityScan(basePackages = "ch.ffhs.fs2025.bth_thesis_javers_hibernateenvers.novers")
@EnableAutoConfiguration(exclude = {JpaRepositoriesAutoConfiguration.class, WebMvcAutoConfiguration.class})
@EnableJpaRepositories(value = "ch.ffhs.fs2025.bth_thesis_javers_hibernateenvers.novers")
public class NoversBenchmarkConfiguration {
}
