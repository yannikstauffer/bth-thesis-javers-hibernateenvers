...
@ComponentScan(
        ...
        excludeFilters = {
                @ComponentScan.Filter(type = FilterType.REGEX,
                        pattern = "ch.ffhs.fs2025.bth_thesis_javers_hibernateenvers.envers.(.*)+"),
                @ComponentScan.Filter(type = FilterType.REGEX,
...
@EntityScan(basePackages = "ch.ffhs.fs2025.bth_thesis_javers_hibernateenvers.javers")
@EnableAutoConfiguration(exclude = {JpaRepositoriesAutoConfiguration.class, WebMvcAutoConfiguration.class})
@EnableJpaRepositories(value = "ch.ffhs.fs2025.bth_thesis_javers_hibernateenvers.javers")
public class JaversBenchmarkConfiguration {
